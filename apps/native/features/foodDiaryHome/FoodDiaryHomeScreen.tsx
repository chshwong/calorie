...
import { addDays } from "@/lib/foodDiary/dateKey";
...
export function FoodDiaryHomeScreen() {
  ...
  const navigateWithDate = (next: Date | string) => {
    // Legacy native route: never navigate back into the removed tab navigator.
    // Route through the gate so the app lands in the wrapped web area.
